...
.\gradlew :user-auth:bootRun --args='--spring.profiles.active=task --seed=UserTypeTranslationDataSeed'
.\gradlew :user-auth:bootRun --args='--spring.profiles.active=task --seed=PermissionDataSeed'
```
